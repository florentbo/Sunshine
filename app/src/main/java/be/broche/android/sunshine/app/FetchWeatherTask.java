...
import static be.broche.android.sunshine.app.data.WeatherContract.WeatherEntry;
...
class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    protected String[] doInBackground(String... params) {
        ...
        Log.v("doInBackground", "XXXXXXXXXXXXXXXXX " + locationQuery);
        ...
        int query_city_id = Integer.valueOf(locationQuery);
        ...
        try {
            ...
            //Preference pref = new Preference(getActivity(),R.string.pref_location_default)
            ...
            builder.scheme("http")
                    ...
                    .appendQueryParameter("id", Integer.toString(query_city_id))
        ...
        try {
            result = getWeatherDataFromJson(forecastJsonStr, locationQuery);
...
//            }
    ...
    String[] convertContentValuesToUXFormat(Vector<ContentValues> cvv) {
        ...
        String[] results = new String[cvv.size()];
